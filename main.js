...
//   =======================
let all_divs =document.querySelectorAll('.trending-slider img')
  all_divs.forEach(e => {
    e.addEventListener('click',function(){
      console.log(data.products[this.id]);
      localStorage.setItem(`data${this.id}`,JSON.stringify(data.products[this.id]))
      index = this.id;
  });
  });
